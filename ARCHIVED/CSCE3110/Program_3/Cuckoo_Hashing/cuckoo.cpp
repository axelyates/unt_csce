...
Name: Axel Yates                                            *
Course: CSCE 3110                                           *
Assignment: Program 3 (Hashing and ADTs) -- Cuckoo Hashing  *
*************************************************************/
...
void place(int key, int tableID, int cnt, int n){
    ...
    if (hashtable[tableID][pos[tableID]]!=INT_MIN){
        ...
        printf("Repositioning necessary, repositioning: %d\n", hashtable[tableID][pos[tableID]]);
        printf("To make room for: %d\n", key);
        printf("Printing Current Table: \n");
