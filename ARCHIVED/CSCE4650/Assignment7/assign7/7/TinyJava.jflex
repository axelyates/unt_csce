...
"."		{ echo (); return symbolFactory . newSymbol ("(punctuation, .)", Symbol . DOT); }
...
"["   { echo (); return symbolFactory . newSymbol ("(operator, [)", Symbol . LBRACK); }
"]"   { echo (); return symbolFactory . newSymbol ("(operator, ])", Symbol . RBRACK); }
...
{Identifier}	{ echo (); return symbolFactory . newSymbol ("(id, " + yytext () + ")", Symbol . ID, yytext ()); }
