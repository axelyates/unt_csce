...
void case9(Course *courses, Student *students, int &num_of_courses, int &num_of_students, char *saved_file);		//function to load previously saved gradebook
void case10(Course *courses, Student *students, int &num_of_courses, int &num_of_students, char *saved_file);		//function to save current information in gradebook
